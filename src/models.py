...
class Player:
    ...
    def assign_summoner(self, summoner: Summoner) -> None:
...
class Team:
    def __init__(self, name: str, overview_page: str | None = None, short: str | None = None, org_location: str | None = None, region: str | None = None) -> None:
        self.name = name
